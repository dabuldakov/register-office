...
@NamedQueries({
        @NamedQuery(name = "getCertByNumber", query = "select ms from MarriageCertificate ms " +
            //    "left join fetch ms.husband " +
              //  "left join fetch ms.wife " +
                "where ms.number = :number")
})
...
public class MarriageCertificate {
    ...
    public void setIssueDate(LocalDate issueNumber) {
        this.issueDate = issueNumber;
    }
